...
{  
    ...
    {    
        longestSubstring("abababababababc");
         
        System.out.println("==========================");
         
        longestSubstring("ABFFIIABDFFFI");
    }    
}
...
public class LongestSubString {
    ...
    public static void main(String a[]){
        ...
        System.out.println(mls.getLongestSubstr("abffiiabdffff"));
        System.out.println(mls.getLongestSubstr("abababababab"));
